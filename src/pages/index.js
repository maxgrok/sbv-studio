...
{/* <SocialLinks /> */}
    ...
    <div className="Block Join">
      ...
      <img src={IconSBV1} />
     <p className="light" style={{fontSize: `22px`, lineHeight: `34px`}}>Studio's first cohort of projects are focused on: </p><br/>
        <div className="Grid">
    ...
    <div className="Block CommunityTokens" id="community-tokens"> {/* was get-involved change the id in the scss file*/}
      <div className="Block__Contents">
        ...
        <div className="GetInvolved_Contents">
            ...
            <p className="light"  style={{fontSize: `22px`, lineHeight: `34px`}}>
